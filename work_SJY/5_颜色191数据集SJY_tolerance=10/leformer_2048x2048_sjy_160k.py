...
data_root = '/home/wangzhecheng/Fengzijie/dataset_splited_SJY_tolerance=10'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='SJYDataset',
            data_root=
            '/home/wangzhecheng/Fengzijie/dataset_splited_SJY_tolerance=10',
...
work_dir = './work_SJY/5_颜色191数据集SJY_tolerance=10'
gpu_ids = [3]
auto_resume = False
